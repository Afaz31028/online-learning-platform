    ...
    <div className="px-30 pt-20 py-35">
      <div className="flex justify-center mt-4">
        <div className="card bg-base-100 w-full max-w-sm shadow-2xl">
          <div className='h-16 bg-blue-800 rounded-t-2xl pt-5'><h1 className="text-center text-2xl font-bold text-white">Please, Sign Up</h1></div>
          <form onSubmit={onSubmit} className="mx-auto mt-8">
            <fieldset className="fieldset">
              ...
              <button type="submit" className="btn mt-5 bg-[#1b55d3] text-white w-80">Sign Up</button>
          ...
          <div>
            ...
            <div className="mt-2 flex justify-center">
             ...
             <div className='mt-10 h-15 bg-blue-800 rounded-b-2xl pt-5 text-center text-white'><p>Already have an account? <Link className='text-lg font-bold text-amber-400' href={"/signin"}> Sign In</Link></p></div>
        </div>
      </div>
    </div>
  );
