...
const Banner = () => {
    return (
        <div className='mt-10 md:px-10 md:py-20 flex md:flex-row flex-col-reverse gap-10 md:justify-center md:gap-30 bg-gray-700 max-w-full md:max-w-7xl mx-auto rounded-2xl'>
